...
- **Completely free** core app — your notes live as `.md` files you own forever
- 1,500+ plugins allow virtually unlimited customization
...
- **Notion:** Export to Markdown or CSV is available but imperfect. Complex database structures don't translate well to flat files.
